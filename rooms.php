    ...
    <div class="site-wrapper">
     ...
     <div class="site-wrapper-inner">
       ...
       <div class="container">
        ...
        <div class="container">
          <h1 class="jumbotron-heading" style="color: white">Rooms & Suites</h1>
          <p class="lead text-muted">Elegantly designed and beautifully furnished, our rooms and suites offer the perfect base from which to explore Hong Kong.</p>
        </div>
      </section>
           ...
           while($row = mysqli_fetch_array($result)){
             echo "<div class='col-sm-4'>";
               echo "<div class='thumbnail'>";
                 ...
                 echo "<p>From PHP ". $row['room_rate'] ."/night</p>";
