    ...
    <div class="site-wrapper">
     ...
     <div class="site-wrapper-inner">
       ...
       <div class="container">
        ...
        <div class="container">
          <h1 class="jumbotron-heading" style="color: white">Facilities</h1>
          <p class="lead text-muted">Our event spaces and boardrooms are suitable for meetings, events, launches and special occasions</p>
        </div>
      </section>
           ...
           while($row = mysqli_fetch_array($result)){
             echo "<div class='col-sm-4'>";
               echo "<div class='thumbnail'>";
                 echo "<img src='uploads/". $row['faci_img'] ."' width='400' height='300'><br>";
                 echo "<p><strong>". $row['faci_name'] ."</strong></p>";
                 echo "<p>". $row['faci_description'] ."</p>";
               echo "</div>";
               echo "</div>";
             }
           }
